...
// object:
	...
	struct T_contr_object_chord_fall_fact_2_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::eval       , AT::back      ,  22,   0,   0,   0,   0,   4 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::lookup     , AT::first     ,   1,   4,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
		...
		constexpr auto contr_object_chord_fall_fact_2_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_fall_fact_2_v0<SizeType>
		>;
