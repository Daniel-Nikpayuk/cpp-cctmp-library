...
// object:
	...
	struct T_contr_object_chord_reassign_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::go_to      , AT::id        ,  19,   0,   0,   0,   0,   1 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::first     ,   7,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
		...
		constexpr auto contr_object_chord_reassign_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_reassign_v0<SizeType>
		>;
