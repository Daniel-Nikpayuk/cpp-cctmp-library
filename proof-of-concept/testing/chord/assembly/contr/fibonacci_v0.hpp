...
// object:
	...
	struct T_contr_object_chord_fibonacci_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::branch     , AT::id        , 104,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::back      ,  21,   0,   0,   0,   0,   4 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::lookup     , AT::first     ,   0,  11,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::back      ,  25,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   1,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::drop      ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			...
			{ AN::type       , AT::n_number  ,   0,   0,   0,   0,   0,   1 },
			{ AN::literal    , AT::back      ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::verse     ,   1,   4,   0,   0,   0,   1 },
			{ AN::bind       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   2,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::replace   ,   0,   0,   0,   0,   0,   1 },
			{ AN::pound      , AT::port      ,   5,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::back      ,  76,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   3,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::drop      ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
		...
		constexpr auto contr_object_chord_fibonacci_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_fibonacci_v0<SizeType>
		>;
