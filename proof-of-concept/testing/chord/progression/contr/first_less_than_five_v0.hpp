...
// object:
	...
	struct T_contr_object_chord_first_less_than_five_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::go_to      , AT::id        , 109,   0,   0,   0,   0,   1 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::go_to      , AT::id        ,  89,   0,   0,   0,   0,   1 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::go_to      , AT::id        ,  81,   0,   0,   0,   0,   1 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			...
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::verse     ,   4,   6,   0,   0,   0,   1 },
			{ AN::next       , AT::id        ,  66,   0,   0,   0,   0,   1 },
			...
			{ AN::next       , AT::id        ,  64,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::none      ,   0,   0,   0,   0,   0,   1 },
			{ AN::cycle      , AT::front     ,  68,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   4,   0,   0,   0,   0,   1 },
			{ AN::find       , AT::id        ,  46,   9,  28,  72,  72,   1 },
			{ AN::find       , AT::back      ,   9,  28,  72,   0,   0,   1 },
			{ AN::cycle      , AT::back      ,  76,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::drop      ,   4,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::pound      , AT::id        ,   7,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::back      ,  92,   1,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   1,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::drop      ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::back      ,  97,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
		...
		constexpr auto contr_object_chord_first_less_than_five_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_first_less_than_five_v0<SizeType>
		>;
