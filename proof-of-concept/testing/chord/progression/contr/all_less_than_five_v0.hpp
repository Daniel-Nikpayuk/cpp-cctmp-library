...
// object:
	...
	struct T_contr_object_chord_all_less_than_five_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::arg        , AT::select    ,   4,   0,   0,   0,   0,   1 },
			{ AN::sift       , AT::id        ,  46,   9,  28,  72,  72,   1 },
			{ AN::sift       , AT::back      ,   9,  28,  72,   0,   0,   1 },
		...
		constexpr auto contr_object_chord_all_less_than_five_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_all_less_than_five_v0<SizeType>
		>;
