...
// interface:
	...
	struct T_chord_assembly_scanner_pda
	{
		...
		nik_ce T_chord_assembly_scanner_pda() : ambiguous{}
		{
			...
			list[390].push({false, 3}); list[390].valid = true; list[390].action = 0;
			list[433].push({false, 3}); list[433].valid = true; list[433].action = 2;
			list[481].push({false, 8}); list[481].valid = true; list[481].action = 0;
			list[525].push({false, 9}); list[525].valid = true; list[525].action = 3;
			list[568].push({false, 9}); list[568].valid = true; list[568].action = 4;
			list[610].push({false, 8}); list[610].valid = true; list[610].action = 0;
			list[655].push({false, 10}); list[655].valid = true; list[655].action = 5;
			list[696].push({false, 8}); list[696].valid = true; list[696].action = 0;
			list[742].push({false, 11}); list[742].valid = true; list[742].action = 6;
			list[777].push({false, 3}); list[777].valid = true; list[777].action = 0;
			list[825].push({false, 8}); list[825].valid = true; list[825].action = 0;
			list[872].push({false, 12}); list[872].valid = true; list[872].action = 6;
			list[906].push({false, 3}); list[906].valid = true; list[906].action = 0;
			list[954].push({false, 8}); list[954].valid = true; list[954].action = 0;
			list[992].push({false, 3}); list[992].valid = true; list[992].action = 7;
			list[994].push({false, 5}); list[994].valid = true; list[994].action = 0;
			list[1035].push({false, 3}); list[1035].valid = true; list[1035].action = 8;
			list[1083].push({false, 8}); list[1083].valid = true; list[1083].action = 0;
			list[1133].push({false, 15}); list[1133].valid = true; list[1133].action = 9;
			list[1169].push({false, 8}); list[1169].valid = true; list[1169].action = 0;
			list[1220].push({false, 16}); list[1220].valid = true; list[1220].action = 6;
			list[1250].push({false, 3}); list[1250].valid = true; list[1250].action = 0;
			list[1298].push({false, 8}); list[1298].valid = true; list[1298].action = 0;
			list[1350].push({false, 17}); list[1350].valid = true; list[1350].action = 9;
			list[1384].push({false, 8}); list[1384].valid = true; list[1384].action = 0;
			list[1433].push({false, 14}); list[1433].valid = true; list[1433].action = 9;
			list[1470].push({false, 8}); list[1470].valid = true; list[1470].action = 0;
			list[1523].push({false, 18}); list[1523].valid = true; list[1523].action = 5;
			list[1556].push({false, 8}); list[1556].valid = true; list[1556].action = 0;
			list[1594].push({false, 3}); list[1594].valid = true; list[1594].action = 10;
			list[1597].push({false, 6}); list[1597].valid = true; list[1597].action = 11;
			list[1598].push({false, 7}); list[1598].valid = true; list[1598].action = 12;
			...
			list[1642].valid = true; list[1642].action = 13;
			list[1647].push({false, 13}); list[1647].push({true, 40}); list[1647].push({true, 38});
			list[1647].valid = true; list[1647].action = 0;
			list[1680].push({false, 3}); list[1680].valid = true; list[1680].action = 10;
			list[1683].push({false, 6}); list[1683].valid = true; list[1683].action = 11;
			list[1684].push({false, 7}); list[1684].valid = true; list[1684].action = 12;
			list[1723].push({false, 3}); list[1723].valid = true; list[1723].action = 10;
			list[1766].push({false, 3}); list[1766].valid = true; list[1766].action = 0;
			list[1769].push({false, 6}); list[1769].valid = true; list[1769].action = 0;
			list[1770].push({false, 7}); list[1770].valid = true; list[1770].action = 0;
			list[1798].push({true, 42}); list[1798].valid = true; list[1798].action = 0;
			list[1799].push({true, 42}); list[1799].valid = true; list[1799].action = 0;
			list[1800].push({true, 42}); list[1800].valid = true; list[1800].action = 0;
			...
			list[1853].push({false, 4}); list[1853].valid = true; list[1853].action = 14;
			list[1895].push({false, 3}); list[1895].valid = true; list[1895].action = 15;
			list[1914].push({false, 22}); list[1914].valid = true; list[1914].action = 16;
			list[1915].push({false, 23}); list[1915].valid = true; list[1915].action = 17;
			list[1917].push({false, 25}); list[1917].valid = true; list[1917].action = 18;
			list[1918].push({false, 26}); list[1918].valid = true; list[1918].action = 19;
			list[1967].push({false, 32}); list[1967].valid = true; list[1967].action = 20;
			list[2011].push({false, 33}); list[2011].valid = true; list[2011].action = 21;
			...
			list[2068].push({false, 4}); list[2068].valid = true; list[2068].action = 22;
			list[2139].push({false, 32}); list[2139].valid = true; list[2139].action = 23;
			list[2183].push({false, 33}); list[2183].valid = true; list[2183].action = 24;
			...
			list[2239].push({false, 3}); list[2239].valid = true; list[2239].action = 25;
			list[2258].push({false, 22}); list[2258].valid = true; list[2258].action = 26;
			list[2259].push({false, 23}); list[2259].valid = true; list[2259].action = 27;
			list[2261].push({false, 25}); list[2261].valid = true; list[2261].action = 28;
			list[2262].push({false, 26}); list[2262].valid = true; list[2262].action = 29;
			list[2311].push({false, 32}); list[2311].valid = true; list[2311].action = 30;
			list[2355].push({false, 33}); list[2355].valid = true; list[2355].action = 31;
			...
			list[2411].push({false, 3}); list[2411].valid = true; list[2411].action = 32;
		}
