...
// interface:
	...
	struct T_chord_assembly_scanner_pda
	{
		...
		nik_ce T_chord_assembly_scanner_pda() : ambiguous{}
		{
			...
			list[347].push({false, 3}); list[347].valid = true; list[347].action = 0;
			list[390].push({false, 3}); list[390].valid = true; list[390].action = 2;
			list[438].push({false, 8}); list[438].valid = true; list[438].action = 0;
			list[482].push({false, 9}); list[482].valid = true; list[482].action = 3;
			list[524].push({false, 8}); list[524].valid = true; list[524].action = 0;
			list[569].push({false, 10}); list[569].valid = true; list[569].action = 5;
			list[610].push({false, 8}); list[610].valid = true; list[610].action = 0;
			list[656].push({false, 11}); list[656].valid = true; list[656].action = 6;
			list[691].push({false, 3}); list[691].valid = true; list[691].action = 0;
			list[739].push({false, 8}); list[739].valid = true; list[739].action = 0;
			list[786].push({false, 12}); list[786].valid = true; list[786].action = 6;
			list[820].push({false, 3}); list[820].valid = true; list[820].action = 0;
			list[868].push({false, 8}); list[868].valid = true; list[868].action = 0;
			list[906].push({false, 3}); list[906].valid = true; list[906].action = 7;
			list[908].push({false, 5}); list[908].valid = true; list[908].action = 0;
			list[949].push({false, 3}); list[949].valid = true; list[949].action = 8;
			list[997].push({false, 8}); list[997].valid = true; list[997].action = 0;
			list[1047].push({false, 15}); list[1047].valid = true; list[1047].action = 9;
			list[1083].push({false, 8}); list[1083].valid = true; list[1083].action = 0;
			list[1134].push({false, 16}); list[1134].valid = true; list[1134].action = 6;
			list[1164].push({false, 3}); list[1164].valid = true; list[1164].action = 0;
			list[1212].push({false, 8}); list[1212].valid = true; list[1212].action = 0;
			list[1264].push({false, 17}); list[1264].valid = true; list[1264].action = 9;
			list[1298].push({false, 8}); list[1298].valid = true; list[1298].action = 0;
			list[1347].push({false, 14}); list[1347].valid = true; list[1347].action = 9;
			list[1384].push({false, 8}); list[1384].valid = true; list[1384].action = 0;
			list[1437].push({false, 18}); list[1437].valid = true; list[1437].action = 5;
			list[1470].push({false, 8}); list[1470].valid = true; list[1470].action = 0;
			list[1508].push({false, 3}); list[1508].valid = true; list[1508].action = 10;
			list[1511].push({false, 6}); list[1511].valid = true; list[1511].action = 11;
			list[1512].push({false, 7}); list[1512].valid = true; list[1512].action = 12;
			...
			list[1556].valid = true; list[1556].action = 13;
			...
			list[1637].push({false, 3}); list[1637].valid = true; list[1637].action = 10;
			list[1680].push({false, 3}); list[1680].valid = true; list[1680].action = 0;
			list[1683].push({false, 6}); list[1683].valid = true; list[1683].action = 0;
			list[1684].push({false, 7}); list[1684].valid = true; list[1684].action = 0;
			list[1712].push({true, 40}); list[1712].valid = true; list[1712].action = 0;
			list[1713].push({true, 40}); list[1713].valid = true; list[1713].action = 0;
			list[1714].push({true, 40}); list[1714].valid = true; list[1714].action = 0;
			...
			list[1767].push({false, 4}); list[1767].valid = true; list[1767].action = 14;
			list[1809].push({false, 3}); list[1809].valid = true; list[1809].action = 15;
			list[1828].push({false, 22}); list[1828].valid = true; list[1828].action = 16;
			list[1829].push({false, 23}); list[1829].valid = true; list[1829].action = 17;
			list[1831].push({false, 25}); list[1831].valid = true; list[1831].action = 18;
			list[1832].push({false, 26}); list[1832].valid = true; list[1832].action = 19;
			list[1881].push({false, 32}); list[1881].valid = true; list[1881].action = 20;
			list[1925].push({false, 33}); list[1925].valid = true; list[1925].action = 21;
			...
			list[1982].push({false, 4}); list[1982].valid = true; list[1982].action = 22;
			list[2053].push({false, 32}); list[2053].valid = true; list[2053].action = 23;
			list[2097].push({false, 33}); list[2097].valid = true; list[2097].action = 24;
			...
			list[2153].push({false, 3}); list[2153].valid = true; list[2153].action = 25;
			list[2172].push({false, 22}); list[2172].valid = true; list[2172].action = 26;
			list[2173].push({false, 23}); list[2173].valid = true; list[2173].action = 27;
			list[2175].push({false, 25}); list[2175].valid = true; list[2175].action = 28;
			list[2176].push({false, 26}); list[2176].valid = true; list[2176].action = 29;
			list[2225].push({false, 32}); list[2225].valid = true; list[2225].action = 30;
			list[2269].push({false, 33}); list[2269].valid = true; list[2269].action = 31;
			...
			list[2325].push({false, 3}); list[2325].valid = true; list[2325].action = 32;
		}
