...
// interface:
	...
	struct T_parser_generator_pda
	{
		...
		nik_ce T_parser_generator_pda()
		{
			...
			list[11].valid = true;
			list[11].action = 8;
			list[12].push({false, 3});
			list[12].push({true, 3});
			list[12].push({true, 1});
			list[12].valid = true;
			list[12].action = 1;
			list[23].push({false, 5});
			list[23].push({true, 5});
			list[23].push({true, 8});
			list[23].push({false, 8});
			list[23].push({true, 4});
			list[23].valid = true;
			list[23].action = 5;
			list[24].push({false, 6});
			list[24].push({true, 11});
			list[24].push({true, 10});
			list[24].push({true, 12});
			list[24].valid = true;
			list[24].action = 0;
			list[32].push({false, 5});
			list[32].push({true, 5});
			list[32].push({true, 8});
			list[32].push({false, 8});
			list[32].push({true, 4});
			list[32].valid = true;
			list[32].action = 6;
			list[33].push({false, 6});
			list[33].push({true, 11});
			list[33].push({true, 10});
			list[33].push({true, 12});
			list[33].valid = true;
			list[33].action = 0;
			list[38].valid = true;
			list[38].action = 0;
			list[39].valid = true;
			list[39].action = 0;
			list[41].push({false, 5});
			list[41].push({true, 5});
			list[41].push({true, 8});
			list[41].push({false, 8});
			list[41].push({true, 4});
			list[41].valid = true;
			list[41].action = 7;
			list[48].push({true, 7});
			...
			list[62].valid = true;
			list[62].action = 0;
			list[66].push({false, 3});
			list[66].valid = true;
			list[66].action = 2;
			list[79].push({false, 7});
			list[79].push({true, 9});
			list[79].valid = true;
			list[79].action = 0;
			list[80].valid = true;
			list[80].action = 0;
			list[84].push({false, 3});
			list[84].valid = true;
			list[84].action = 4;
			list[93].push({true, 11});
			list[93].push({true, 10});
			list[93].valid = true;
			list[93].action = 0;
			list[98].valid = true;
			list[98].action = 0;
			list[102].push({false, 3});
			list[102].valid = true;
			list[102].action = 0;
			list[116].push({false, 8});
			list[116].valid = true;
			list[116].action = 0;
		}
