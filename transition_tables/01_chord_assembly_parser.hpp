...
// interface:
	...
	struct T_chord_assembly_pda
	{
		...
		nik_ce T_chord_assembly_pda() : ambiguous{}
		{
			...
			list[1960].push({true, 65}); list[1960].push({true, 61}); list[1960].push({true, 67});
			list[1960].push({true, 66}); list[1960].valid = true; list[1960].action = 0;
			list[1962].push({true, 65}); list[1962].push({true, 61}); list[1962].push({true, 67});
			list[1962].push({true, 66}); list[1962].valid = true; list[1962].action = 0;
			list[2003].push({true, 65}); list[2003].push({true, 61}); list[2003].push({true, 67});
			list[2003].push({true, 66}); list[2003].valid = true; list[2003].action = 0;
			list[2005].push({true, 65}); list[2005].push({true, 61}); list[2005].push({true, 67});
			list[2005].push({true, 66}); list[2005].valid = true; list[2005].action = 0;
			list[2046].push({true, 65}); list[2046].push({true, 61}); list[2046].push({true, 66});
			list[2046].valid = true; list[2046].action = 0;
			list[2048].push({true, 65}); list[2048].push({true, 61}); list[2048].push({true, 66});
			list[2048].valid = true; list[2048].action = 0;
			list[2089].push({true, 65}); list[2089].push({true, 61}); list[2089].push({true, 67});
			list[2089].push({true, 66}); list[2089].valid = true; list[2089].action = 0;
			list[2091].push({true, 65}); list[2091].push({true, 61}); list[2091].push({true, 67});
			list[2091].push({true, 66}); list[2091].valid = true; list[2091].action = 0;
			list[2132].push({true, 65}); list[2132].push({true, 61}); list[2132].push({true, 66});
			list[2132].valid = true; list[2132].action = 0;
			list[2134].push({true, 65}); list[2134].push({true, 61}); list[2134].push({true, 66});
			list[2134].valid = true; list[2134].action = 0;
			list[2175].push({true, 65}); list[2175].push({true, 61}); list[2175].push({true, 67});
			list[2175].push({true, 66}); list[2175].valid = true; list[2175].action = 0;
			list[2177].push({true, 65}); list[2177].push({true, 61}); list[2177].push({true, 67});
			list[2177].push({true, 66}); list[2177].valid = true; list[2177].action = 0;
			list[2218].push({true, 65}); list[2218].push({true, 62}); list[2218].push({true, 66});
			list[2218].valid = true; list[2218].action = 0;
			list[2220].push({true, 65}); list[2220].push({true, 62}); list[2220].push({true, 66});
			list[2220].valid = true; list[2220].action = 0;
			list[2261].push({true, 65}); list[2261].push({true, 62}); list[2261].push({true, 67});
			list[2261].push({true, 62}); list[2261].push({true, 66}); list[2261].valid = true; list[2261].action = 0;
			list[2263].push({true, 65}); list[2263].push({true, 62}); list[2263].push({true, 67});
			list[2263].push({true, 62}); list[2263].push({true, 66}); list[2263].valid = true; list[2263].action = 0;
			list[2304].push({true, 65}); list[2304].push({true, 62}); list[2304].push({true, 66});
			list[2304].valid = true; list[2304].action = 0;
			list[2306].push({true, 65}); list[2306].push({true, 62}); list[2306].push({true, 66});
			list[2306].valid = true; list[2306].action = 0;
			list[2347].push({true, 65}); list[2347].push({true, 62}); list[2347].push({true, 66});
			list[2347].valid = true; list[2347].action = 0;
			list[2349].push({true, 65}); list[2349].push({true, 62}); list[2349].push({true, 66});
			list[2349].valid = true; list[2349].action = 0;
			list[2390].push({true, 65}); list[2390].push({true, 62}); list[2390].push({true, 67});
			list[2390].push({true, 62}); list[2390].push({true, 66}); list[2390].valid = true; list[2390].action = 0;
			list[2392].push({true, 65}); list[2392].push({true, 62}); list[2392].push({true, 67});
			list[2392].push({true, 62}); list[2392].push({true, 66}); list[2392].valid = true; list[2392].action = 0;
			list[2433].push({true, 65}); list[2433].push({true, 62}); list[2433].push({true, 66});
			list[2433].valid = true; list[2433].action = 0;
			list[2435].push({true, 65}); list[2435].push({true, 62}); list[2435].push({true, 66});
			list[2435].valid = true; list[2435].action = 0;
			list[2476].push({true, 65}); list[2476].push({true, 62}); list[2476].push({true, 67});
			list[2476].push({true, 62}); list[2476].push({true, 66}); list[2476].valid = true; list[2476].action = 0;
			list[2478].push({true, 65}); list[2478].push({true, 62}); list[2478].push({true, 67});
			list[2478].push({true, 62}); list[2478].push({true, 66}); list[2478].valid = true; list[2478].action = 0;
			list[2519].push({true, 65}); list[2519].push({true, 62}); list[2519].push({true, 66});
			list[2519].valid = true; list[2519].action = 0;
			list[2521].push({true, 65}); list[2521].push({true, 62}); list[2521].push({true, 66});
			list[2521].valid = true; list[2521].action = 0;
			list[2562].push({true, 65}); list[2562].push({true, 62}); list[2562].push({true, 66});
			list[2562].valid = true; list[2562].action = 0;
			list[2564].push({true, 65}); list[2564].push({true, 62}); list[2564].push({true, 66});
			list[2564].valid = true; list[2564].action = 0;
			list[2605].push({true, 65}); list[2605].push({true, 62}); list[2605].push({true, 67});
			list[2605].push({true, 62}); list[2605].push({true, 66}); list[2605].valid = true; list[2605].action = 0;
			list[2607].push({true, 65}); list[2607].push({true, 62}); list[2607].push({true, 67});
			list[2607].push({true, 62}); list[2607].push({true, 66}); list[2607].valid = true; list[2607].action = 0;
			list[2626].push({true, 64}); list[2626].valid = true; list[2626].action = 39;
			list[2643].push({true, 64}); list[2643].valid = true; list[2643].action = 39;
			list[2644].push({true, 64}); list[2644].valid = true; list[2644].action = 39;
			list[2645].push({false, 22}); list[2645].valid = true; list[2645].action = 42;
			list[2646].push({false, 23}); list[2646].valid = true; list[2646].action = 43;
			...
			list[2688].valid = true; list[2688].action = 44;
			list[2689].push({false, 23}); list[2689].push({false, 19}); list[2689].push({false, 22});
			list[2689].valid = true; list[2689].action = 45;
			...
			list[2733].push({false, 24}); list[2733].valid = true; list[2733].action = 49;
			list[2755].push({false, 3}); list[2755].valid = true; list[2755].action = 46;
			list[2772].push({false, 20}); list[2772].valid = true; list[2772].action = 48;
			list[2773].push({false, 21}); list[2773].valid = true; list[2773].action = 47;
			list[2820].push({false, 25}); list[2820].valid = true; list[2820].action = 50;
			list[2822].push({false, 27}); list[2822].valid = true; list[2822].action = 51;
			list[2864].push({false, 26}); list[2864].valid = true; list[2864].action = 52;
			list[2866].push({false, 28}); list[2866].valid = true; list[2866].action = 53;
			list[2912].push({false, 31}); list[2912].valid = true; list[2912].action = 54;
		}
