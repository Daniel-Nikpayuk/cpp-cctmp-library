...
// interface:
	...
	struct T_chord_pda
	{
		...
		nik_ce T_chord_pda() : ambiguous{}
		{
			...
			list[3357].push({true, 92}); list[3357].push({true, 89}); list[3357].push({true, 96});
			list[3357].valid = true; list[3357].action = 0;
			list[3384].push({true, 71}); list[3384].push({true, 77}); list[3384].push({true, 72});
			list[3384].push({true, 80}); list[3384].push({true, 72}); list[3384].push({true, 82});
			list[3384].push({true, 72}); list[3384].push({true, 85}); list[3384].push({true, 73});
			list[3384].valid = true; list[3384].action = 0;
			list[3432].push({false, 24}); list[3432].valid = true; list[3432].action = 43;
			list[3482].push({false, 26}); list[3482].valid = true; list[3482].action = 44;
			list[3529].push({false, 25}); list[3529].valid = true; list[3529].action = 44;
			list[3558].push({false, 6}); list[3558].valid = true; list[3558].action = 45;
			list[3579].push({false, 27}); list[3579].valid = true; list[3579].action = 45;
			list[3580].push({false, 28}); list[3580].valid = true; list[3580].action = 45;
			list[3606].push({true, 74}); list[3606].valid = true; list[3606].action = 0;
			list[3627].push({true, 74}); list[3627].valid = true; list[3627].action = 0;
			list[3628].push({true, 74}); list[3628].valid = true; list[3628].action = 0;
			list[3630].push({false, 30}); list[3630].valid = true; list[3630].action = 45;
			list[3631].push({false, 31}); list[3631].valid = true; list[3631].action = 45;
			list[3654].push({false, 6}); list[3654].valid = true; list[3654].action = 46;
			list[3675].push({false, 27}); list[3675].valid = true; list[3675].action = 46;
			list[3676].push({false, 28}); list[3676].valid = true; list[3676].action = 46;
			list[3702].push({true, 75}); list[3702].push({true, 78}); list[3702].valid = true; list[3702].action = 47;
			list[3723].push({true, 75}); list[3723].push({true, 78}); list[3723].valid = true; list[3723].action = 47;
			list[3724].push({true, 75}); list[3724].push({true, 78}); list[3724].valid = true; list[3724].action = 47;
			list[3726].push({true, 75}); list[3726].push({true, 78}); list[3726].valid = true; list[3726].action = 47;
			list[3727].push({true, 75}); list[3727].push({true, 78}); list[3727].valid = true; list[3727].action = 47;
			list[3750].push({true, 76}); list[3750].push({true, 79}); list[3750].valid = true; list[3750].action = 0;
			list[3770].valid = true; list[3770].action = 48;
			list[3771].push({true, 76}); list[3771].push({true, 79}); list[3771].valid = true; list[3771].action = 0;
			list[3772].push({true, 76}); list[3772].push({true, 79}); list[3772].valid = true; list[3772].action = 0;
			list[3798].push({true, 76}); list[3798].valid = true; list[3798].action = 0;
			list[3818].valid = true; list[3818].action = 49;
			list[3819].push({true, 76}); list[3819].valid = true; list[3819].action = 0;
			list[3820].push({true, 76}); list[3820].valid = true; list[3820].action = 0;
			list[3846].push({true, 74}); list[3846].push({true, 81}); list[3846].valid = true; list[3846].action = 50;
			list[3866].valid = true; list[3866].action = 51;
			list[3867].push({true, 74}); list[3867].push({true, 81}); list[3867].valid = true; list[3867].action = 50;
			list[3868].push({true, 74}); list[3868].push({true, 81}); list[3868].valid = true; list[3868].action = 50;
			list[3894].push({true, 76}); list[3894].push({true, 81}); list[3894].valid = true; list[3894].action = 0;
			list[3914].valid = true; list[3914].action = 52;
			list[3915].push({true, 76}); list[3915].push({true, 81}); list[3915].valid = true; list[3915].action = 0;
			list[3916].push({true, 76}); list[3916].push({true, 81}); list[3916].valid = true; list[3916].action = 0;
			list[3942].push({true, 75}); list[3942].push({true, 83}); list[3942].valid = true; list[3942].action = 53;
			list[3962].valid = true; list[3962].action = 54;
			list[3963].push({true, 75}); list[3963].push({true, 83}); list[3963].valid = true; list[3963].action = 53;
			list[3964].push({true, 75}); list[3964].push({true, 83}); list[3964].valid = true; list[3964].action = 53;
			list[3966].push({true, 75}); list[3966].push({true, 83}); list[3966].valid = true; list[3966].action = 53;
			list[3967].push({true, 75}); list[3967].push({true, 83}); list[3967].valid = true; list[3967].action = 53;
			list[3990].push({true, 76}); list[3990].push({true, 84}); list[3990].valid = true; list[3990].action = 0;
			list[4010].valid = true; list[4010].action = 55;
			list[4011].push({true, 76}); list[4011].push({true, 84}); list[4011].valid = true; list[4011].action = 0;
			list[4012].push({true, 76}); list[4012].push({true, 84}); list[4012].valid = true; list[4012].action = 0;
			list[4038].push({true, 76}); list[4038].valid = true; list[4038].action = 0;
			list[4058].valid = true; list[4058].action = 56;
			list[4059].push({true, 76}); list[4059].valid = true; list[4059].action = 0;
			list[4060].push({true, 76}); list[4060].valid = true; list[4060].action = 0;
			list[4086].push({true, 75}); list[4086].push({true, 86}); list[4086].valid = true; list[4086].action = 57;
			list[4105].valid = true; list[4105].action = 58;
			list[4107].push({true, 75}); list[4107].push({true, 86}); list[4107].valid = true; list[4107].action = 57;
			list[4108].push({true, 75}); list[4108].push({true, 86}); list[4108].valid = true; list[4108].action = 57;
			list[4110].push({true, 75}); list[4110].push({true, 86}); list[4110].valid = true; list[4110].action = 57;
			list[4111].push({true, 75}); list[4111].push({true, 86}); list[4111].valid = true; list[4111].action = 57;
			list[4134].push({true, 76}); list[4134].push({true, 87}); list[4134].valid = true; list[4134].action = 0;
			list[4153].valid = true; list[4153].action = 59;
			list[4155].push({true, 76}); list[4155].push({true, 87}); list[4155].valid = true; list[4155].action = 0;
			list[4156].push({true, 76}); list[4156].push({true, 87}); list[4156].valid = true; list[4156].action = 0;
			list[4182].push({true, 76}); list[4182].valid = true; list[4182].action = 0;
			list[4201].valid = true; list[4201].action = 60;
			list[4203].push({true, 76}); list[4203].valid = true; list[4203].action = 0;
			list[4204].push({true, 76}); list[4204].valid = true; list[4204].action = 0;
			list[4257].push({true, 90}); list[4257].push({true, 94}); list[4257].push({true, 91});
			list[4257].valid = true; list[4257].action = 0;
			list[4259].push({true, 90}); list[4259].push({true, 94}); list[4259].push({true, 91});
			list[4259].valid = true; list[4259].action = 0;
			list[4305].push({true, 90}); list[4305].push({true, 94}); list[4305].push({false, 39});
			list[4305].push({true, 95}); list[4305].push({true, 91}); list[4305].valid = true; list[4305].action = 0;
			list[4307].push({true, 90}); list[4307].push({true, 94}); list[4307].push({false, 39});
			list[4307].push({true, 95}); list[4307].push({true, 91}); list[4307].valid = true; list[4307].action = 0;
			list[4353].push({false, 33}); list[4353].valid = true; list[4353].action = 61;
			list[4355].push({false, 35}); list[4355].valid = true; list[4355].action = 62;
			list[4402].push({false, 34}); list[4402].valid = true; list[4402].action = 63;
			list[4404].push({false, 36}); list[4404].valid = true; list[4404].action = 64;
			list[4453].push({false, 37}); list[4453].push({false, 38}); list[4453].valid = true; list[4453].action = 65;
			list[4497].push({true, 88}); list[4497].valid = true; list[4497].action = 0;
			list[4499].push({true, 88}); list[4499].valid = true; list[4499].action = 0;
			list[4501].push({true, 92}); list[4501].valid = true; list[4501].action = 0;
			list[4542].push({false, 30}); list[4542].push({false, 26}); list[4542].push({false, 31});
			list[4542].valid = true; list[4542].action = 66;
			list[4543].push({false, 31}); list[4543].push({false, 26}); list[4543].push({false, 30});
			list[4543].valid = true; list[4543].action = 67;
			list[4546].valid = true; list[4546].action = 69;
			list[4548].valid = true; list[4548].action = 69;
			list[4551].valid = true; list[4551].action = 69;
			list[4590].push({false, 30}); list[4590].push({false, 26}); list[4590].push({false, 31});
			list[4590].valid = true; list[4590].action = 73;
			list[4594].valid = true; list[4594].action = 75;
			list[4596].valid = true; list[4596].action = 75;
			list[4622].valid = true; list[4622].action = 81;
			list[4641].push({true, 93}); list[4641].push({true, 96}); list[4641].valid = true; list[4641].action = 0;
			list[4643].push({true, 93}); list[4643].push({true, 96}); list[4643].valid = true; list[4643].action = 0;
			list[4645].push({true, 93}); list[4645].push({true, 96}); list[4645].valid = true; list[4645].action = 0;
		}
