...
/***********************************************************************************************************************/
	...
	{
		constexpr auto static_contr = hustle::metapile<callable_source, initial_env>;

		auto file_ptr = fopen("square_root_v0.hpp", "w");
...
/***********************************************************************************************************************/
	...
	{
		write_controller<_hustle_square_root_v0, null_env>();
