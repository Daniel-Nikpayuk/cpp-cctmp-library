...
// object:
	...
	struct T_contr_object_hustle_fibonacci_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::go_to      , AT::id        ,  61,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::eval       , AT::back      ,   7,   0,   0,   0,   0,   4 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::lookup     , AT::first     ,   0,   8,   0,   0,   0,   1 }, 
			...
			{ AN::pound      , AT::port      ,   5,   0,   0,   0,   0,   1 }, 
			{ AN::eval       , AT::back      ,  45,   0,   0,   0,   0,   4 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::lookup     , AT::first     ,   0,  13,   0,   0,   0,   1 }, 
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::eval       , AT::back      ,  49,   0,   0,   0,   0,   5 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::arg        , AT::select    ,   1,   0,   0,   0,   0,   1 }, 
			{ AN::arg        , AT::drop      ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 }, 
		...
		constexpr auto contr_object_hustle_fibonacci_v0 = cctmp::U_store_T
		<
			T_contr_object_hustle_fibonacci_v0<SizeType>
		>;
