...
// object:
	...
	struct T_contr_object_hustle_sum_of_squares_v1
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::go_to      , AT::id        ,  63,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::go_to      , AT::id        ,  49,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::go_to      , AT::id        ,  26,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
		...
		constexpr auto contr_object_hustle_sum_of_squares_v1 = cctmp::U_store_T
		<
			T_contr_object_hustle_sum_of_squares_v1<SizeType>
		>;
