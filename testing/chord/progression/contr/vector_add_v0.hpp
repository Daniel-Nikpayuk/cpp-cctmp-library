...
// object:
	...
	struct T_contr_object_chord_vector_add_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::go_to      , AT::id        ,  95,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::go_to      , AT::id        ,  90,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			...
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::out_in_ins , AT::pred      ,  57,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::out_in_ins , AT::act_mut   ,   9,  39,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::arg        , AT::verse     ,   5,   5,   0,   0,   0,   1 }, 
			{ AN::next       , AT::cont      ,  75,   1,   0,   0,   0,   1 }, 
			{ AN::next       , AT::cont      ,  75,   3,   0,   0,   0,   1 }, 
			{ AN::next       , AT::cont      ,  75,   4,   0,   0,   0,   1 }, 
			{ AN::next       , AT::end       ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::cycle      , AT::side      ,  81,  83,   0,   0,   0,   1 }, 
			{ AN::arg        , AT::select    ,   5,   0,   0,   0,   0,   1 }, 
			{ AN::cycle      , AT::id        ,  79,  89,   0,   0,   0,   1 }, 
			{ AN::arg        , AT::drop      ,   5,   0,   0,   0,   0,   1 }, 
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::pound      , AT::id        ,   7,   0,   0,   0,   0,   1 }, 
			{ AN::eval       , AT::back      ,  98,   1,   0,   0,   0,   5 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
		...
		constexpr auto contr_object_chord_vector_add_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_vector_add_v0<SizeType>
		>;
