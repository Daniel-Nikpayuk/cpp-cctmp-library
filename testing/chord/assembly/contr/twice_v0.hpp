...
// object:
	...
	struct T_contr_object_chord_twice_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::go_to      , AT::id        ,  33,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::go_to      , AT::id        ,  23,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
		...
		constexpr auto contr_object_chord_twice_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_twice_v0<SizeType>
		>;
