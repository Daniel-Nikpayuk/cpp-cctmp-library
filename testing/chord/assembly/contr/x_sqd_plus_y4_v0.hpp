...
// object:
	...
	struct T_contr_object_chord_x_sqd_plus_y4_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::eval       , AT::back      ,  64,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   2,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::drop      ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::back      ,  69,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   3,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::drop      ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::verse     ,   3,   4,   0,   0,   0,   1 },
			{ AN::bind       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   2,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::replace   ,   0,   0,   0,   0,   0,   1 },
			{ AN::pound      , AT::id        ,  61,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::back      ,  80,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
		...
		constexpr auto contr_object_chord_x_sqd_plus_y4_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_x_sqd_plus_y4_v0<SizeType>
		>;
