...
// object:
	...
	struct T_contr_object_chord_if_then_else_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::branch     , AT::id        ,  23,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::first     ,  19,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   3,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::drop      ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::first     ,  25,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
		...
		constexpr auto contr_object_chord_if_then_else_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_if_then_else_v0<SizeType>
		>;
