...
// object:
	...
	struct T_contr_object_chord_semidynamic_typing_v1
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::go_to      , AT::id        ,  51,   0,   0,   0,   0,   1 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::eval       , AT::back      ,   7,   0,   0,   0,   0,   4 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::lookup     , AT::first     ,   1,  11,   0,   0,   0,   1 }, 
			...
			{ AN::branch     , AT::id        ,  40,   0,   0,   0,   0,   1 }, 
			{ AN::eval       , AT::back      ,  23,   0,   0,   0,   0,   4 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::lookup     , AT::first     ,   1,  24,   0,   0,   0,   1 }, 
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 }, 
		...
		constexpr auto contr_object_chord_semidynamic_typing_v1 = cctmp::U_store_T
		<
			T_contr_object_chord_semidynamic_typing_v1<SizeType>
		>;
