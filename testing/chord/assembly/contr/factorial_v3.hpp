...
// object:
	...
	struct T_contr_object_chord_factorial_v3
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::arg        , AT::select    ,   2,   0,   0,   0,   0,   1 }, 
			{ AN::arg        , AT::replace   ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::go_to      , AT::id        ,   5,   0,   0,   0,   0,   1 }, 
			{ AN::eval       , AT::first     ,  51,   0,   0,   0,   0,   5 }, 
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::arg        , AT::select    ,   1,   0,   0,   0,   0,   1 }, 
			{ AN::arg        , AT::drop      ,   0,   0,   0,   0,   0,   1 }, 
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 }, 
		...
		constexpr auto contr_object_chord_factorial_v3 = cctmp::U_store_T
		<
			T_contr_object_chord_factorial_v3<SizeType>
		>;
