...
// object:
	...
	struct T_contr_object_chord_fall_fact_2_v1
	{
		...
		constexpr auto contr_object_chord_fall_fact_2_v1 = cctmp::U_store_T
		<
			T_contr_object_chord_fall_fact_2_v1<SizeType>
		>;
