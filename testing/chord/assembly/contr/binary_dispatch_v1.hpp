...
// object:
	...
	struct T_contr_object_chord_binary_dispatch_v1
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::pad        , AT::select    ,   6,   1,   0,   0,   0,   1 },
			{ AN::pad        , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::first     ,   9,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			...
			{ AN::eval       , AT::back      ,  16,   0,   0,   0,   0,   4 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::lookup     , AT::first     ,   0,  11,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::back      ,  20,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			...
			{ AN::branch     , AT::id        ,  29,   0,   0,   0,   0,   1 },
			{ AN::go_to      , AT::id        ,  36,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::first     ,  31,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
		...
		constexpr auto contr_object_chord_binary_dispatch_v1 = cctmp::U_store_T
		<
			T_contr_object_chord_binary_dispatch_v1<SizeType>
		>;
