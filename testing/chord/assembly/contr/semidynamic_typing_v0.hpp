...
// object:
	...
	struct T_contr_object_chord_semidynamic_typing_v0
	{
		...
		constexpr static size_type value[][8] =
		{
			...
			{ AN::branch     , AT::id        ,  41,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::back      ,  24,   0,   0,   0,   0,   4 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::lookup     , AT::first     ,   0,  24,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
			...
			{ AN::literal    , AT::first     ,   5,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   1,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::replace   ,   0,   0,   0,   0,   0,   1 },
			{ AN::eval       , AT::first     ,  47,   0,   0,   0,   0,   5 },
			{ AN::id         , AT::id        ,   0,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::select    ,   1,   0,   0,   0,   0,   1 },
			{ AN::arg        , AT::drop      ,   0,   0,   0,   0,   0,   1 },
			{ AN::halt       , AT::first     ,   0,   0,   0,   0,   0,   1 },
		...
		constexpr auto contr_object_chord_semidynamic_typing_v0 = cctmp::U_store_T
		<
			T_contr_object_chord_semidynamic_typing_v0<SizeType>
		>;
