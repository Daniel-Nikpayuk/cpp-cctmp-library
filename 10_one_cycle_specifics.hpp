...
namespace cctmp_one_cycle_generics {
	...
	template<auto... Vs> nik_ce auto eval			= cctmp::template eval<Vs...>;
	...
	struct Chord
	{
		enum : gkey_type
		{
			id = 0,
				...
				ival  , axis  , note       ,
				major , minor , diminished , augmented , quality ,

			// ray:

				repeat , fold , find_first , find_all ,

			// line:

				map , zip , fasten , glide ,
...
// is tone augmented:
	...
	{
		return eval<_and_, holds, T_store_U<right_closed_tones>::axis::is_bidirectional...>;
	}
...
// axis:
	...
	// line:
		...
		struct T_chord<Chord::axis, _next<Next>, _prev<Prev>>
		{
			...
			nik_ces auto is_bidirectional	= ! eval<_same_, Prev, _id_>;
		};
...
// major:
	...
	{
		nik_ces auto holds = eval<_and_, Notes::ival::is_right_open...>;
	};
...
// minor:
	...
	{
		nik_ces auto holds = Root::ival::is_right_closed && eval<_or_, Tones::ival::is_right_open...>;
	};
...
// diminished:
	...
	{
		nik_ces auto holds = eval<_and_, Notes::ival::is_right_closed...>;
	};
...
// augmented:
	...
	{
		nik_ces auto holds	= Root::ival::is_right_open && eval<_or_, Tones::ival::is_right_closed...>;
