...
// none:
	...
	struct T_continuant<MN::halt, MT::none, filler...>
	{
...
// first:
	...
	template<auto... filler>
	struct T_continuant<MN::halt, MT::first, filler...>
	{
...
// pause:
	...
	template<auto... filler>
	struct T_continuant<MN::halt, MT::pause, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs) { } // return LambdaTuple::make(vs...); }
	};
...
// boolean:
	...
	template<auto... filler>
	struct T_continuant<MN::type, MT::boolean, filler...>
	{
...
// character:
	...
	template<auto... filler>
	struct T_continuant<MN::type, MT::character, filler...>
	{
...
// n_number:
	...
	template<auto... filler>
	struct T_continuant<MN::type, MT::n_number, filler...>
	{
...
// r_number:
	...
	template<auto... filler>
	struct T_continuant<MN::type, MT::r_number, filler...>
	{
...
// push:
	...
	template<auto... filler>
	struct T_continuant<MN::type, MT::push, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// pull:
	...
	template<auto... filler>
	struct T_continuant<MN::type, MT::pull, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// first:
	...
	template<auto... filler>
	struct T_continuant<MN::literal, MT::first, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename T, typename... Ts>
...
// back:
	...
	template<auto... filler>
	struct T_continuant<MN::literal, MT::back, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// first:
	...
	template<auto... filler>
	struct T_continuant<MN::floating, MT::first, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename T, typename... Ts>
		nik_ces auto result(T v, Ts... vs)
		{
...
// back:
	...
	template<auto... filler>
	struct T_continuant<MN::floating, MT::back, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// first:
	...
	template<auto... filler>
	struct T_continuant<MN::lookup, MT::first, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename T, typename... Ts>
		nik_ces auto result(T v, Ts... vs)
		{
...
// back:
	...
	template<auto... filler>
	struct T_continuant<MN::lookup, MT::back, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// push:
	...
	template<auto... filler>
	struct T_continuant<MN::lookup, MT::push, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// select:
	...
	template<auto... filler>
	struct T_continuant<MN::arg, MT::select, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// verse:
	...
	template<auto... filler>
	struct T_continuant<MN::arg, MT::verse, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// drop:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::arg, MT::drop, p0, p1, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
...
// replace:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::arg, MT::replace, p0, p1, filler...>
	{
