...
// select:
	...
	struct T_continuant<MN::pad, MT::select, filler...>
	{
...
// id:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::pad, MT::id, p0, p1, p2, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
...
// id:
	...
	template<auto... filler>
	struct T_continuant<MN::hash, MT::id, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
			nik_ce auto ni = MD<c>::pos(i);
			nik_ce auto nv = U_continuant_compound<c, ni>;
...
// port:
	...
	template<auto... filler>
	struct T_continuant<MN::hash, MT::port, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
			...
			nik_ce auto nv = U_continuant_compound<s, c, ni>;
...
// id:
	...
	template<auto... filler>
	struct T_continuant<MN::pound, MT::id, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// port:
	...
	template<auto... filler>
	struct T_continuant<MN::pound, MT::port, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
/*
	template<auto... filler>
	struct T_continuant<MN::pound, MT::pull, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// first:
	...
	template<auto... filler>
	struct T_continuant<MN::eval, MT::first, filler...>
	{
...
// back:
	...
	template<auto... filler>
	struct T_continuant<MN::eval, MT::back, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// side:
	...
	template<auto... filler>
	struct T_continuant<MN::eval, MT::side, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// first:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::apply, MT::first, p0, p1, filler...>
	{
...
// back:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::apply, MT::back, p0, p1, filler...>
	{
		using RT = T_store_U<RU>;
...
// side:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::apply, MT::side, p0, p1, filler...>
	{
		using RT = T_store_U<RU>;
...
// first:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::bind, MT::first, p0, p1, p2, filler...>
	{
		using LT = T_store_U<LU>;
		using RT = T_store_U<RU>;
...
// back:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::bind, MT::back, p0, p1, p2, filler...>
	{
		using RT = T_store_U<RU>;
...
// side:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::bind, MT::side, p0, p1, p2, filler...>
	{
		using RT = T_store_U<RU>;
