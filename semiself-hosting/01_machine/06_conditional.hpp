...
// id:
	...
	struct T_continuant<MN::go_to, MT::id, filler...>
	{
...
// id:
	...
	template<auto... filler>
	struct T_continuant<MN::branch, MT::id, filler...>
	{
...
// id:
	...
	template<auto... filler>
	struct T_continuant<MN::invert, MT::id, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename T, typename... Ts>
		nik_ces auto result(T v, Ts... vs)
		{
...
// id:
	...
	template<auto... filler>
	struct T_continuant<MN::loop, MT::id, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// front:
	...
	template<auto... filler>
	struct T_continuant<MN::cycle, MT::front, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// back:
	...
	struct T_continuant<MN::cycle, MT::back, p0, p1, filler...>
	{
		template<NIK_MACHINE_PARAMS(c, i, l, t, r), typename... Ts>
		nik_ces auto result(Ts... vs)
		{
...
// drop:
	...
	>
	struct T_continuant<MN::cycle, MT::drop, p0, p1, filler...>
	{
...
// id:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::next, MT::id, p0, p1, p2, filler...>
	{
...
// side:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::next, MT::side, p0, p1, filler...>
	{
		using RT = T_store_U<RU>;
...
// inc(rement):
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::next, MT::inc, p0, p1, filler...>
	{
		using RT = T_store_U<RU>;
...
// dec(rement):
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::next, MT::dec, p0, p1, filler...>
	{
		using RT = T_store_U<RU>;
...
// id:
	...
	<
		...
		auto... filler
	>
	struct T_continuant<MN::set, MT::id, p0, p1, filler...>
	{
...
// id:
	...
	>
	struct T_continuant<MN::repeat, MT::id, p0, p1, filler...>
	{
...
// back:
	...
	<
		...
		nik_vp(p1)(B1<OU, EU, IUs...>*), auto... filler
	>
	struct T_continuant<MN::repeat, MT::back, p0, p1, filler...>
	{
		static_assert(sizeof...(IUs), "{ MN::repeat, MT::id } requires at least one in argument.");
...
// id:
	...
	>
	struct T_continuant<MN::map, MT::id, p0, p1, filler...>
	{
		using Out = T_store_U<OU>;
...
// back:
	...
	<
		...
		nik_vp(p1)(B1<OU, IU, EU, IUs...>*), auto... filler
	>
	struct T_continuant<MN::map, MT::back, p0, p1, filler...>
	{
		using Out = T_store_U<OU>;
		using In  = T_store_U<IU>;
		using End = T_store_U<EU>;
...
// id:
	...
	<
		...
		nik_vp(p1)(B1<OU, IU, EU, IUs...>*), auto... filler
	>
	struct T_continuant<MN::fold, MT::id, p0, p1, filler...>
	{
		using Out = T_store_U<OU>;
		using In  = T_store_U<IU>;
		using End = T_store_U<EU>;
...
// back:
	...
	<
		...
		nik_vp(p1)(B1<OU, IU, EU, IUs...>*), auto... filler
	>
	struct T_continuant<MN::fold, MT::back, p0, p1, filler...>
	{
		using Out = T_store_U<OU>;
		using In  = T_store_U<IU>;
		using End = T_store_U<EU>;
...
// id:
	...
	<
		...
		nik_vp(p1)(B1<OU, IU, EU, IUs...>*), auto... filler
	>
	struct T_continuant<MN::find, MT::id, p0, p1, filler...>
	{
		using LT  = T_store_U<LU>;
		using Out = T_store_U<OU>;
		using In  = T_store_U<IU>;
...
// back:
	...
	<
		...
		nik_vp(p1)(B1<OU, IU, EU, IUs...>*), auto... filler
	>
	struct T_continuant<MN::find, MT::back, p0, p1, filler...>
	{
		using LT  = T_store_U<LU>;
		using Out = T_store_U<OU>;
		using In  = T_store_U<IU>;
...
// id:
	...
	<
		...
		nik_vp(p1)(B1<OU, IU, EU, IUs...>*), auto... filler
	>
	struct T_continuant<MN::sift, MT::id, p0, p1, filler...>
	{
		using Out = T_store_U<OU>;
		using In  = T_store_U<IU>;
		using End = T_store_U<EU>;
...
// back:
	...
	<
		...
		nik_vp(p1)(B1<OU, IU, EU, IUs...>*), auto... filler
	>
	struct T_continuant<MN::sift, MT::back, p0, p1, filler...>
	{
		using Out = T_store_U<OU>;
		using In  = T_store_U<IU>;
		using End = T_store_U<EU>;
