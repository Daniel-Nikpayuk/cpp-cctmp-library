...
// subtuple:
	...
	template<template<typename, typename, auto> typename, typename...> struct csubtuple;
...
// immutable:
	...
	class csubtuple<Index, SizeType, T_pack_Vs<Is...>, Types...> : public Index<Types, SizeType, Is>...
	{
		public:
		...
		public:
			...
			nik_ce csubtuple() : Index<Types, size_type, Is>{}... { }
			nik_ce csubtuple(const Types &... vs) : Index<Types, size_type, Is>{vs}... { }
...
// mutable:
	...
	class subtuple : public csubtuple<Index, SizeType, Sizes, Types...>
	{
		public:

			using base		= csubtuple<Index, SizeType, Sizes, Types...>;
		...
		public:
			...
			nik_ce subtuple() : base{} { }
			nik_ce subtuple(const Types &... vs) : base{vs...} { }
...
// immutable:
	...
	class ctuple : public csubtuple<tuple_cindex, SizeType, T_store_U<segment_<sizeof...(Types)>>, Types...>
	{
		public:

			using seg_pack		= T_store_U<segment_<sizeof...(Types)>>;

			using base		= csubtuple<tuple_cindex, SizeType, seg_pack, Types...>;
...
// mutable:
	...
	template<typename SizeType, typename... Types>
	class tuple : public subtuple<tuple_index, SizeType, T_store_U<segment_<sizeof...(Types)>>, Types...>
	{
		public:

			using seg_pack		= T_store_U<segment_<sizeof...(Types)>>;

			using base		= subtuple<tuple_index, SizeType, seg_pack, Types...>;
...
// continuant:
	...
	template<gkey_type, gkey_type, auto...> struct T_continuant;
...
// apply:
	...
	struct T_metapile_apply
	{
		...
		nik_ces auto result(Ts... vs)
		{
			return T_continuant_compound<static_contr, zero>::template
