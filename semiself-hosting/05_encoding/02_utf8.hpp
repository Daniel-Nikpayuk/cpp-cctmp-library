...
// interface:
	...
	struct utf8_byte
	{
		...
		nik_ces char_type range[Range::dimension][Byte::dimension] =
		{
			...
			{ 0xe1,0xec , 0x80,0xbf , 0x80,0xbf , 0x00,0x7f }, // 3
			{ 0xed,0xed , 0x80,0x9f , 0x80,0xbf , 0x00,0x7f }, // 4
			{ 0xee,0xef , 0x80,0xbf , 0x80,0xbf , 0x00,0x7f }, // 5
			{ 0xf0,0xf0 , 0x90,0xbf , 0x80,0xbf , 0x80,0xbf }, // 6 char4
			{ 0xf1,0xf3 , 0x80,0xbf , 0x80,0xbf , 0x80,0xbf }, // 7
			{ 0xf4,0xf4 , 0x80,0x8f , 0x80,0xbf , 0x80,0xbf }  // 8
		};
