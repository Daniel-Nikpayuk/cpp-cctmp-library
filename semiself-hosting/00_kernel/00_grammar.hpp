...
// image trait:
	...
	struct image_trait
	{
		...
		using mode		= typename alias<Mode>::type;
		using mode_ptr		= typename alias<Mode>::type_ptr;
		using mode_cptr		= typename alias<Mode>::type_cptr;
		using mode_ref		= typename alias<Mode>::type_ref;
